...
export function valida(input) {
    ...
    if (validadores[tipoDeInput]) { // si tipo de input existe en validadores
        validadores[tipoDeInput](input); // pasamos como parámetro el input
    }
    console.log(input.parentElement);
    // si el valid de validity es true elimina la clase "invalid"
